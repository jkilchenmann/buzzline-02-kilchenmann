...
py -m producers.kafka_producer_kilchenmann
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.kafka_producer_kilchenmann
```
...
```shell
.venv\Scripts\activate
py -m consumers.kafka_consumer_kilchenmann
```
